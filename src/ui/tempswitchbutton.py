...
class TempSwitchButton(QAbstractButton):
    """Found from: https://stackoverflow.com/questions/14780517/toggle-switch-in-qt 
    """

    def __init__(self, parent=None, track_radius=10, thumb_radius=5):
        ...
        if self._thumb_radius > self._track_radius:
            ...
            self._track_color = {
                True: QColor(174, 214, 241),
                False: QColor(169, 223, 191),
            }
            self._text_color = {
                True: QColor(41, 128, 185),
                False: QColor(39, 174, 96),
            }
            self._thumb_text = {
                True: '°F',
                False: '°C',
